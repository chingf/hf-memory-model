...
class PlotMaker(object):
    ...
    def plot_slider(
            self, K_max=0.6, Ncr_max=80, Jcr_max=0.1,
        ...
        Args:
            ...
            K (float): parameter for the global inhibition added to units 
        ...
        def update(val):
            ...
            print("Raw Value: %1.2f"%np.max(bump_f))
            print("Value Above Mean: %1.2f"%bump_height)
            print()
